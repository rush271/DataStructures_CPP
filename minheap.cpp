...
void minHeap :: buildMin(string &filename) {
...
int minHeap :: findMin() {
    reshape();
	return heap[0]; // Returns the minimum value of the minHeap
}

int minHeap :: getSize() {
	return size; // Returns the size of the minHeap
}

void minHeap :: reshape() {
